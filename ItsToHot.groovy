 ...
 *  It's Too Hot
 *
 *  Author: Iain Partington
 */
definition(
    name: "It's Too Hot",
    namespace: "ipartington",
    author: "ipartington@gmail.com",
    description: "Monitor the temperature and when it goes above your setting get a text and/or turn on a heater or additional appliance. Based off the smartapp for too Cold",
...
preferences {
	...
	section("Turn on a air conditioner...") {
...
def temperatureHandler(evt) {
	...
	if (evt.doubleValue >= tooHot) {
		...
		if (alreadySentSms) {
			...
			log.debug "Temperature dropped above $tooHot:  sending SMS and activating $mySwitch"
